  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const res = await fetch(
      process.env.NODE_ENV === "development"
        ...
        : `https://albion-erp-system.vercel.app/api/update-item/${id}`,
      {
        method: "PATCH",
    ...
    const getSignleItem = async () => {
      const res = await fetch(
        process.env.NODE_ENV === "development"
          ...
          : `https://albion-erp-system.vercel.app/api/get-item/${id}`
      );
      ...
      data.cities.map(
        (city: City) =>
          (currentCities = { ...currentCities, [city.name]: city.price })
      );
